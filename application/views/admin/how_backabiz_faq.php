...
<div class="padding">
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header">
          <h2>Add New FAQ</h2><span><div style="text-align:right;"><a href="<?php echo base_url('admin/backabiz_faq_list')?>" class="md-btn md-raised m-b-sm w-xs blue"  >Faq List</a></div>
        <?php
  ...
  ?>
        ...
        <div class="box-body">
          <form role="form" method="post" action="<?php echo base_url('admin/backabiz_insert_faq')?>">
